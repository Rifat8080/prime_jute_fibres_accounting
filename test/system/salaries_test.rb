...
class SalariesTest < ApplicationSystemTestCase
  ...
  test "should create salary" do
    ...
    fill_in "Notes", with: @salary.notes
    fill_in "Payment date", with: @salary.payment_date
    fill_in "Payment period end", with: @salary.payment_period_end
    fill_in "Payment period start", with: @salary.payment_period_start
